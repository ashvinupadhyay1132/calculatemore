import { GpaCalculatorPageClient } from "./client";
import { allCalculators } from "@/config/calculators";
import type { Metadata } from "next";

export async function generateMetadata(): Promise<Metadata> {
  const calculator = allCalculators.find((c) => c.href === "/calculators/gpa");
  if (!calculator) {
    return {
...
export default function GpaCalculatorPage() {
  ...
  return <GpaCalculatorPageClient calculator={calculator} faqSchema={schema} />;
}
