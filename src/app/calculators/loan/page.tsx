...
export default function LoanCalculatorPage() {
  const calculator = allCalculators.find((c) => c.href === "/calculators/loan")!;
  ...
  return <LoanCalculatorPageClient calculator={calculator} faqSchema={schema} />;
}
