...
function CalorieCalculatorForm({
  ...
  const ResultDisplay = ({ result }: { result: CalorieResult }) => (
    <div className="space-y-4">
      <h4 className="font-headline text-lg text-center">
        Daily Calorie Goals
      </h4>
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-right">Calories/day</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          <TableRow className="text-destructive">
            <TableCell>Extreme Weight Loss (~2 lb/week)</TableCell>
            <TableCell className="text-right font-bold">
              {result.extremeLoss.toLocaleString()}
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Weight Loss (~1 lb/week)</TableCell>
            <TableCell className="text-right font-bold">
              {result.loss.toLocaleString()}
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Mild Weight Loss (~0.5 lb/week)</TableCell>
            <TableCell className="text-right font-bold">
          ...
          <TableRow>
            <TableCell>Mild Weight Gain (~0.5 lb/week)</TableCell>
            <TableCell className="text-right font-bold">
              {result.mildGain.toLocaleString()}
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Weight Gain (~1 lb/week)</TableCell>
            <TableCell className="text-right font-bold">
      ...
      <p className="text-xs text-muted-foreground text-center pt-2">
        These are estimates. Consult a professional for personalized advice. A deficit of 500 calories per day is generally recommended for a healthy weight loss of 1 lb per week.
      </p>
    </div>
  );
...
export function CalorieCalculatorPageClient({
  ...
  return (
    <CalculatorPage
      ...
      faqSchema={faqSchema}
    >
      <CalorieCalculatorForm setResult={setResult} />
    </CalculatorPage>
  );
}
